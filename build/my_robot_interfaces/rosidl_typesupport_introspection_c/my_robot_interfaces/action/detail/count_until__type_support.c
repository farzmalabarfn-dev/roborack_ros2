...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__action__CountUntil_Goal__rosidl_typesupport_introspection_c__CountUntil_Goal_message_member_array[1] = {
  {
    "target_count",  // name
    ...
    offsetof(my_robot_interfaces__action__CountUntil_Goal, target_count),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__action__CountUntil_Result__rosidl_typesupport_introspection_c__CountUntil_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__action__CountUntil_Result, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
