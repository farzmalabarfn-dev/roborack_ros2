...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CountUntil_Goal_message_member_array[1] = {
  {
    "target_count",  // name
    ...
    offsetof(my_robot_interfaces::action::CountUntil_Goal, target_count),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CountUntil_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::action::CountUntil_Result, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
